...
const WhatIsTycoon = () => {
    return (
        <section className="w-full relative px-4 py-12 bg-[#010F10]">
            <div className="w-full game-panel rounded-xl bg-[#0B191A]/80 backdrop-blur-sm border border-[#003B3E]/60 px-6 py-10 relative overflow-hidden">
                ...
                <main className="relative flex flex-col justify-center items-center gap-8">
                    ...
                    <p className="font-dmSans font-[400] text-[16px] text-[#E0F7F8] -tracking-[2%] leading-relaxed max-w-xl border-l-2 border-[#00F0FF]/50 pl-6">
