...
/**
 * Bell + badge for lobby / DM unread. Opens a sheet to jump into chats.
 */
  ...
  return (
    <>
      <button
        ...
        className={`relative flex h-11 w-11 items-center justify-center rounded-xl border border-[#00F0FF]/25 bg-gradient-to-b from-[#03383a] to-[#011112] text-white/90 transition hover:border-[#00F0FF]/40 hover:shadow-[0_0_16px_rgba(0,240,255,0.12)] active:scale-[0.97] ${className}`}
      >
